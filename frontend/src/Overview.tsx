...
export default function Overview({ context, selectedCount, go, demo }: {
  ...
  return <div className="page-enter">
    ...
    <section className="hero">
      ...
      <div className="city-art" aria-hidden="true"><svg viewBox="0 0 500 280" fill="none"><defs><linearGradient id="cityfade" x1="240" y1="40" x2="240" y2="280" gradientUnits="userSpaceOnUse"><stop stopColor="#b6d8b4" stopOpacity=".7"/><stop offset="1" stopColor="#b6d8b4" stopOpacity=".08"/></linearGradient></defs><ellipse cx="260" cy="252" rx="229" ry="18" stroke="#77a695" strokeOpacity=".3"/><path d="M25 252H478M41 261H445" stroke="#77a695" strokeOpacity=".4"/><circle cx="299" cy="91" r="61" stroke="#8fb7a5" strokeOpacity=".13"/><circle cx="299" cy="91" r="81" stroke="#8fb7a5" strokeOpacity=".08"/><path d="M49 249V152L89 128L129 152V249M63 153V235M76 143V234M91 142V235M107 153V235M134 249V178H171V249M142 189H163M142 201H163M142 213H163M142 225H163M183 249V148L211 130L239 148V249M194 157V235M210 148V235M225 157V235M261 249L283 112M335 249L314 112M285 112H312M274 165H324M269 186H328M265 207H331M257 229H339M346 249V166H379V249M354 176H370M354 190H370M354 204H370M354 218H370M393 249V152H426V249M409 151V130M401 165H418M401 180H418M401 195H418M401 210H418M441 249V194H466V249" stroke="url(#cityfade)" strokeWidth="1.7"/><circle cx="299" cy="91" r="25" fill="#d1e6ac" fillOpacity=".15" stroke="#d1e6ac" strokeWidth="1.5"/><ellipse cx="299" cy="91" rx="13" ry="25" stroke="#d1e6ac" strokeOpacity=".6"/><path d="M274 91H324M277 79H321M277 103H321" stroke="#d1e6ac" strokeOpacity=".6"/><path d="M280 230L298 139L317 230" stroke="#b7d7b6" strokeOpacity=".5"/><circle cx="126" cy="81" r="3" fill="#d1e6ac"/><path d="M425 78V91M419 84H431M176 47V57M171 52H181" stroke="#d1e6ac" strokeOpacity=".5"/></svg><div className="art-coordinate">ASTANA · URBAN LAB</div></div>
